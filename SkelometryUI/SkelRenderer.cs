...
using Skelometry;
using Point = Skelometry.Point;

namespace SkelometryUI
{
    public class SkelRenderer
    {
	    public int Width { get; set; }
	    public int Height { get; set; }

	    public SkelRenderer(int width = 250, int height = 250)
	    {
		    Width = width;
		    Height = height;
		    GenPens(height*4);
        }
        public void Draw(Graphics g, SkelAgent agent)
        {
