...
namespace Slugs.Agent
{
	...
	public abstract class BaseAgent : IAgent
	{
		...
		public BaseAgent(SlugRenderer renderer)
		{
			ActiveAgent = this;
			Agent.SlugAgent.Pads[WorkingPad.PadIndex] = WorkingPad;
		...
		public SKPoint this[IPointRef pointRef]
		{
			get
			{
				...
				if (!pointRef.IsEmpty)
				{
					var pad = Agent.SlugAgent.Pads[pointRef.PadIndex];
		...
		{
			var pad = Agent.SlugAgent.Pads[from.PadIndex];
