...
namespace Slugs.Constraints
{
    ...
    public class ParallelConstraint : EqualConstraint
    {
	    public ParallelConstraint(Trait startElement, Trait endElement, LengthLock lengthLock) :
		    base(startElement, endElement, lengthLock, DirectionLock.Parallel) { }
    }
